<?php
    ...
    class DataOperations {
        ...
        public function getData ( $tabla , $select , $orderby , $ordermode , $startat , $endat , $conexion ) {
        ...
        public function getDataFilter ( $tabla , $select , $key , $value , $orderby , $ordermode , $startat , $endat , $conexion ) {
        ...
        public function getTablesData ( $rel , $type , $select , $orderby , $ordermode , $startat , $endat , $conexion ) {
        ...
        public function getTablesDataFilter ( $rel , $type , $select , $key , $value , $orderby , $ordermode , $startat , $endat , $conexion ) {
        ...
        public function getDataSearch ( $tabla , $select , $key , $search , $orderby , $ordermode , $startat , $endat , $conexion ) {
        ...
        public function getTablesDataSearch ( $rel , $type , $select , $key , $search , $orderby , $ordermode , $startat , $endat , $conexion ) {
        ...
        public function getDataRange ( $tabla , $select , $key , $betweenstart , $betweenend , $orderby , $ordermode , $startat , $endat , $filter , $in , $conexion ) {
        ...
        public function getTablesDataRange ( $rel , $type , $select , $linkTo , $betweenstart , $betweenend , $orderby , $ordermode , $startat , $endat , $filter , $in , $conexion ) {
